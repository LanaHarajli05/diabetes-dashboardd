...
print("🌐 Open your dashboard here:", url)
...
# Adjust if needed — this assumes the file is in /content/ now
shutil.copy("/content/diabetes_clean.csv", "/content/drive/MyDrive/diabetes_dashboard/diabetes_clean.csv")
...
# 🔑 Add your correct Ngrok token here (PASTE IT CLEANLY)
...
# ngrok.set_auth_token("your_real_token")  ← Only needed once
